...
CREATE TABLE `recruiter` (
  ...
  CONSTRAINT `recruiter_ibfk_1` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`user_account_id`)
...
INSERT INTO `recruiter` VALUES (1,'company1',12),(2,'company2',13),(3,'company3',14),(4,'company4',15);
